...
You need \texttt{\textbackslash usepackage\{import\}}, \texttt{\textbackslash usepackage\{graphicx\}}, and \texttt{\textbackslash usepackage\{xcolor\}}.
...
\begin{figure}[ht]
    ...
    \caption{
        ...
        Prisoner number 8 opens box 8, then box 6, then box 5, and stops because he finds his number.
...
\begin{figure}[ht]
    \centering
    \incfig[0.75]{figures/lorenz/}{lorenz}
    \caption{
        Lorenz curve. The curve shows the cumulative distribution of income
        across the population. Point $A$ marks the median income and point $B$
        marks the mean income.
    }
    \label{fig:lorenz}
\end{figure}
